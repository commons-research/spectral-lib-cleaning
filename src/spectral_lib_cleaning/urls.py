...
GNPS_LIBS = [
    ...
    "SUMNER.mgf",
    "UM-NPDC.mgf",
    # Load the multiplex synthesis lib
    "MULTIPLEX-SYNTHESIS-LIBRARY-ALL-PARTITION-1.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-ALL-PARTITION-2.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-ALL-PARTITION-3.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-ALL-PARTITION-4.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-ALL-PARTITION-5.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-ALL-PARTITION-6.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-FILTERED-PARTITION-1.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-FILTERED-PARTITION-2.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-FILTERED-PARTITION-3.mgf",
    "MULTIPLEX-SYNTHESIS-LIBRARY-FILTERED-PARTITION-4.mgf",
]
